                    ...
                    <tbody>
                        <tr>
                            ...
                            <td class="cart-product-thumbnail">
                                <a href="#">
                                    <img src="{{ asset('polo-5/images/shop/products/1.jpg') }}" alt="Bolt Sweatshirt">
                                </a>
                        ...
                        <tr>
                            ...
                            <td class="cart-product-thumbnail">
                                <a href="#">
                                    <img alt="Consume Tshirt" src="{{ asset('polo-5/images/shop/products/2.jpg') }}">
                                </a>
                        ...
                        <tr>
                            ...
                            <td class="cart-product-thumbnail">
                                <a href="#">
                                    <img src="{{ asset('polo-5/images/shop/products/3.jpg') }}" alt="Logo Tshirt">
                                </a>
                        ...
                        <tr>
                            ...
                            <td class="cart-product-thumbnail">
                                <a href="#">
                                    <img src="{{ asset('polo-5/images/shop/products/5.jpg') }}" alt="Grey Sweatshirt">
                                </a>
