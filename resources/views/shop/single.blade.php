                ...
                <div class="col-lg-5">
                    <div class="product-image">
                        ...
                        <div class="carousel dots-inside dots-dark arrows-visible" data-items="1" data-loop="true" data-autoplay="true" data-animate-in="fadeIn" data-animate-out="fadeOut" data-autoplay="2500" data-lightbox="gallery">
                            <a href="{{ asset('polo-5/images/shop/products/product-large.jpg') }}" data-lightbox="image" title="Shop product image!"><img alt="Shop product image!" src="{{ asset('polo-5/images/shop/products/1.jpg') }}">
                            </a>
                            <a href="{{ asset('polo-5/images/shop/products/product-large.jpg') }}" data-lightbox="image" title="Shop product image!"><img alt="Shop product image!" src="{{ asset('polo-5/images/shop/products/2.jpg') }}">
                            </a>
                        </div>
                        <!-- Carousel slider -->
                    </div>
